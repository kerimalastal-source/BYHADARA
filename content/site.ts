...
export const dictionaries = {
  en: {
    ...
    learn: 'Explore the business',
    official: 'Visit company website',
    officialPending:
      'For information about HADARA Real Estate, please contact the group. The official website link will be added once verified.',
    imageNote: 'Illustrative photography. Not a BYHADARA property or facility.',
    business: [
      {
        name: 'HADARA Real Estate',
        sector: 'Real Estate Development & Investment',
        desc: 'Developing property opportunities with a long-term perspective, focused on residential and commercial real estate in Türkiye.',
        detail:
          'HADARA Real Estate focuses on real estate development and investment activities in Türkiye, particularly Istanbul. Its dedicated business platform is intended for property information, projects, and client inquiries.',
        areas: [
        ...
        markets: 'Türkiye, with a particular focus on Istanbul.',
        image: 'architecture.jpg',
        alt: 'Reflective glass facade of a contemporary building',
      },
      {
        name: 'HADARA Hospitality',
        sector: 'Hospitality Supply & Procurement',
        desc: 'Connecting hospitality businesses with thoughtfully sourced hotel textiles and essentials from Türkiye.',
        detail:
          'An Istanbul-based hospitality supply business specializing in sourcing and supplying hotel textiles and hospitality essentials for hotels, resorts, serviced apartments, and procurement professionals.',
        areas: [
          'Hotel bed linen',
          'Towels & bath textiles',
          'Bathrobes',
          'Hotel slippers',
          'Beach & pool textiles',
          'Guest room essentials',
        ],
        markets: 'Türkiye and international markets, including the GCC.',
        image: 'hospitality.jpg',
        alt: 'White linen in a light-filled hotel room',
      },
    ],
    markets: 'OUR MARKETS',
    ...
    termsSections: [
      ...
      [
        'Website content',
        'Brand names and original website content identify the group and its businesses. Licensed photographs are illustrative and do not depict claimed group properties, offices, or projects.',
      ],
      [
        'Responsible use',
  ...
  ar: {
    ...
    official: 'زيارة موقع الشركة',
    officialPending:
      'للاستفسار عن حضارة العقارية، يرجى التواصل مع المجموعة. سيُضاف رابط الموقع الرسمي بعد التحقق منه.',
    imageNote: 'صور توضيحية لا تمثل عقارات أو مرافق تابعة للمجموعة.',
    business: [
      {
        name: 'حضارة العقارية',
        sector: 'التطوير والاستثمار العقاري',
        desc: 'تطوير الفرص العقارية برؤية طويلة الأمد، مع التركيز على العقارات السكنية والتجارية في تركيا.',
        detail:
          'تركز حضارة العقارية على أنشطة التطوير والاستثمار العقاري في تركيا، ولا سيما إسطنبول. وتختص منصتها المستقلة بمعلومات العقارات والمشاريع واستفسارات العملاء.',
        areas: [
          'التطوير العقاري',
          'الفرص العقارية السكنية',
          'الفرص العقارية التجارية',
          'الاستثمار العقاري',
        ],
        markets: 'تركيا، مع تركيز خاص على إسطنبول.',
        image: 'architecture.jpg',
        alt: 'واجهة زجاجية عاكسة لمبنى معاصر',
      },
      {
        name: 'حضارة للضيافة',
        sector: 'توريد وتجهيز مستلزمات الضيافة',
        desc: 'نربط قطاع الضيافة بمنسوجات فندقية ومستلزمات مختارة بعناية من تركيا.',
        detail:
          'شركة لتوريد مستلزمات الضيافة مقرها إسطنبول، متخصصة في تأمين وتوريد المنسوجات الفندقية والمستلزمات الأساسية للفنادق والمنتجعات والشقق الفندقية ومتخصصي المشتريات.',
        areas: [
          'بياضات الأسرّة الفندقية',
          'المناشف ومنسوجات الحمام',
          'أردية الحمام',
          'نعال الفنادق',
          'منسوجات الشاطئ والمسابح',
          'مستلزمات غرف الضيوف',
        ],
        markets: 'تركيا والأسواق الدولية، بما فيها دول مجلس التعاون الخليجي.',
        image: 'hospitality.jpg',
        alt: 'بياضات سرير بيضاء في غرفة فندقية مضيئة',
      },
    ],
    markets: 'أسواقنا',
    ...
    termsSections: [
      ...
      [
        'محتوى الموقع',
        'تعرّف الأسماء التجارية والمحتوى الأصلي بالمجموعة وشركاتها. الصور المرخصة توضيحية ولا تُنسب إلى عقارات أو مكاتب أو مشاريع المجموعة.',
      ],
      [
        'الاستخدام المسؤول',
  ...
  tr: {
    ...
    official: 'Şirketin web sitesini ziyaret edin',
    officialPending:
      'HADARA Real Estate hakkında bilgi için grupla iletişime geçebilirsiniz. Resmi web sitesi bağlantısı doğrulandıktan sonra eklenecektir.',
    imageNote: 'Fotoğraflar temsilidir; BYHADARA mülk veya tesislerini göstermez.',
    business: [
      {
        name: 'HADARA Real Estate',
        sector: 'Gayrimenkul Geliştirme ve Yatırım',
        desc: 'Türkiye’de konut ve ticari gayrimenkul fırsatlarını uzun vadeli bir bakış açısıyla geliştirmek.',
        detail:
          'HADARA Real Estate, başta İstanbul olmak üzere Türkiye’de gayrimenkul geliştirme ve yatırım faaliyetlerine odaklanır. Bağımsız şirket platformu gayrimenkul bilgileri, projeler ve müşteri talepleri için tasarlanmıştır.',
        areas: [
          'Gayrimenkul geliştirme',
          'Konut fırsatları',
          'Ticari gayrimenkul fırsatları',
          'Gayrimenkul yatırımı',
        ],
        markets: 'Özellikle İstanbul olmak üzere Türkiye.',
        image: 'architecture.jpg',
        alt: 'Çağdaş bir binanın yansıtıcı cam cephesi',
      },
      {
        name: 'HADARA Hospitality',
        sector: 'Konaklama Tedariki ve Satın Alma',
        desc: 'Konaklama işletmelerini Türkiye’den özenle tedarik edilen otel tekstili ve temel ihtiyaçlarla buluşturuyor.',
        detail:
          'İstanbul merkezli HADARA Hospitality; oteller, tatil köyleri, hizmetli daireler ve satın alma profesyonelleri için otel tekstili ve konaklama ihtiyaçlarının tedarikinde uzmanlaşır.',
        areas: [
          'Otel yatak tekstili',
          'Havlular ve banyo tekstili',
          'Bornozlar',
          'Otel terlikleri',
          'Plaj ve havuz tekstili',
          'Misafir odası ihtiyaçları',
        ],
        markets: 'Türkiye ve Körfez ülkeleri dahil uluslararası pazarlar.',
        image: 'hospitality.jpg',
        alt: 'Aydınlık bir otel odasında beyaz yatak tekstili',
      },
    ],
    ...
    termsSections: [
      ...
      [
        'Site içeriği',
        'Marka isimleri ve özgün içerikler grubu ve şirketlerini tanıtır. Lisanslı fotoğraflar temsilidir; gruba ait olduğu iddia edilen mülk, ofis veya projeleri göstermez.',
      ],
      [
        'Sorumlu kullanım',
